...
# Anagram Solution 3 : NOT FEASIBLE!
...
print(anagramSolution1('abcd',raw_input("enter anagram for abcd: ")))
print(anagramSolution2('abcde',raw_input("enter anagram for abcde: ")))
print(anagramSolution4('apple',raw_input("enter anagram for apple: ")))
